...
[Backends, configuring and extending](https://github.com/cskwrd/go-guerrilla/wiki/Backends,-configuring-and-extending) page.
...
- Modular [Backend system](https://github.com/cskwrd/go-guerrilla/wiki/Backends,-configuring-and-extending) 
- Modern TLS support (STARTTLS or SMTPS).
- Can be [used as a package](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package) in your Go project. 
Get started in just a few lines of code!
- [Fuzz tested](https://github.com/cskwrd/go-guerrilla/wiki/Fuzz-testing). 
...
Take a look at our [Bounties and Roadmap](https://github.com/cskwrd/go-guerrilla/wiki/Roadmap-and-Bounties) page!
...
See the [build notes](https://github.com/cskwrd/go-guerrilla/wiki/Build-Notes) for more details.
...
The configuration options are detailed on the [configuration page](https://github.com/cskwrd/go-guerrilla/wiki/Configuration). 
...
- Try setting up an [example configuration](https://github.com/cskwrd/go-guerrilla/wiki/Configuration-example:-save-to-Redis-&-MySQL) 
...
- Try hacking the source and [create your own processor](https://github.com/cskwrd/go-guerrilla/wiki/Backends,-configuring-and-extending).
- Once your daemon is running, you might want to stup [log rotation](https://github.com/cskwrd/go-guerrilla/wiki/Automatic-log-file-management-with-logrotate).
...
```go
import (
    "github.com/cskwrd/go-guerrilla"
)
...
Next, you may want to [change the interface](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#starting-a-server---custom-listening-interface) (`127.0.0.1:2525`) to the one of your own choice.

#### API Documentation topics

Please continue to the [API documentation](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package) for the following topics:


- [Suppressing log output](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#starting-a-server---suppressing-log-output)
- [Custom listening interface](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#starting-a-server---custom-listening-interface)
- [What else can be configured](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#what-else-can-be-configured)
- [Backends](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#backends)
    - [About the backend system](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#about-the-backend-system)
    - [Backend Configuration](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#backend-configuration)
    - [Registering a Processor](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#registering-a-processor)
- [Loading config from JSON](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#loading-config-from-json)
- [Config hot-reloading](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#config-hot-reloading)
- [Logging](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#logging-stuff)
- [Log re-opening](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#log-re-opening)
- [Graceful shutdown](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#graceful-shutdown)
- [Pub/Sub](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#pubsub)
- [More Examples](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#more-examples)
...
- [guerrillad command](https://github.com/cskwrd/go-guerrilla/wiki/Running-from-command-line#guerrillad-command)
    - [Starting](https://github.com/cskwrd/go-guerrilla/wiki/Running-from-command-line#starting)
    - [Re-loading configuration](https://github.com/cskwrd/go-guerrilla/wiki/Running-from-command-line#re-loading-the-config)
    - [Re-open logs](https://github.com/cskwrd/go-guerrilla/wiki/Running-from-command-line#re-open-log-file)
    - [Examples](https://github.com/cskwrd/go-guerrilla/wiki/Running-from-command-line#examples)

### Other topics

- [Using Nginx as a proxy](https://github.com/cskwrd/go-guerrilla/wiki/Using-Nginx-as-a-proxy)
- [Testing STARTTLS](https://github.com/cskwrd/go-guerrilla/wiki/Running-from-command-line#testing-starttls)
- [Benchmarking](https://github.com/cskwrd/go-guerrilla/wiki/Profiling#benchmarking)
...
[Daemon.AddProcessor](https://github.com/cskwrd/go-guerrilla/wiki/Using-as-a-package#registering-a-processor) function to register, then add to your config.
...
See our [change log](https://github.com/cskwrd/go-guerrilla/wiki/Change-Log) for change and release history
...
For such purposes as load balancing, terminating TLS early,
 ...
 it is possible to [use NGINX as a proxy](https://github.com/cskwrd/go-guerrilla/wiki/Using-Nginx-as-a-proxy).
